...
const listerbalanceUSDT = await ethers.provider.getBalance(member1.address);
    console.log("Lister Balance found", listerbalanceUSDT);

const buyerBalalnceUSDT = await ethers.provider.getBalance(member2.address);
    console.log("Buyer Balance found", buyerBalalnceUSDT);
